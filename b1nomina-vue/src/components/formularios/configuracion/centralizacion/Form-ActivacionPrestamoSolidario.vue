...
const MostrarValores = (DATA) => {
    EstadoCampo.value = (DATA?.prestamo_solidario_imponible == 1)? true : false;
 ...
 */
 const Enviar = async () => {
    ...
    const respuesta = await peticiones_configuracion?.ActualizarEstadoPrestamoSolidario(
